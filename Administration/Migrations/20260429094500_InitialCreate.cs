        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Departements = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Utilisateur",
                columns: new[] { "Id", "DateCreation", "DateDerniereConnexion", "Departements", "Email", "IsActive", "MotPasse", "NomUtilisateur", "PhotoUrl", "Role" },
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "admin@gmail.com", true, "$2a$11$8K1pQYlG9lYk1ExampleHashReplaceThis1234567890", "admin", null, "Admin" });
